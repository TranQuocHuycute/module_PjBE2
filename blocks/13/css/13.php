...
<head>
  ...
  <title>13</title>
	...
	<link rel="stylesheet" href="/13/css/bootstrap.min.css" type="text/css"> 
	<link rel="stylesheet" href="/13/css/bootstrap.min.css" type="text/css"> 
</head>
...
<div class="col-lg-4">
				<div class="top-player">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" id="home-tab" data-toggle="tab" href="#rating" role="tab" aria-controls="home" aria-selected="true">Rating</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" id="profile-tab" data-toggle="tab" href="#goals" role="tab" aria-controls="profile" aria-selected="false">Goals</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" id="contact-tab" data-toggle="tab" href="#assists" role="tab" aria-controls="contact" aria-selected="false">Assists</a>
						</li>
					</ul>

					<div class="tab-content">
						<div class="tab-pane fade show active table-responsive" id="rating" role="tabpanel" aria-labelledby="home-tab">
							<table class="table">
								<tr>
